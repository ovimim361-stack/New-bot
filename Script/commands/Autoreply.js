...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "Hmm": "হুম চ*দাস কেনো😈 হুম এর কি রিপ্লাই দিব",
    ...
    "@সুহা শিনী": "ম্যানশন দিয়ে লাভ নাই এটা অভির হবু বউ মানে তদের ভাবি লাগে🤐🤧..!", 
    ...
    "@Ariana Sultana Ruhi": "গ্রুপে রুহি রুহি না করলে ইনবক্সে গিয়ে প্রপোজ করলেও তো পারিস📢😩😏🥱",
